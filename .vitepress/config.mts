    ...
    sidebar: [
      {
        items: [
          ...
          { text: "Convert Time to Milliseconds", link: "/convert-time-to-milliseconds" },
          ...
          { text: "Dictionary Context Provider", link: "/dictionary-context-provider" },
          ...
          { text: "Hello World Translations", link: "/hello-world-translations" },
          ...
          { text: "Redux Root Reducer Setup", link: "/redux-root-reducer-setup" },
          { text: "Regex Text Utility", link: "/regex-text-utility" },
          { text: "Scroll to Top Component", link: "/scroll-to-top-component" },
          { text: "Service Configuration Guide", link: "/service-configuration-guide" },
          ...
          { text: "Theme Switcher Component", link: "/theme-switcher-component" },
          { text: "TypeScript Glob Patterns", link: "/typescript-glob-patterns" },
          { text: "Website Configuration", link: "/website-configuration" },
          { text: "Window Manager Utility", link: "/window-manager-utility" }
